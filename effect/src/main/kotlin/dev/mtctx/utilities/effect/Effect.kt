 ...
 * @see Outcome
 */
abstract class Effect<A : Any>(val thunk: suspend () -> A) {
     ...
     */
    abstract fun <B : Any> map(transform: suspend (A) -> B): Effect<B>
     ...
     */
    abstract fun <B : Any> flatMap(transform: suspend (A) -> Effect<B>): IO<B>
     ...
     */
    abstract fun <B : Any> ap(function: Effect<(A) -> B>): Effect<B>
